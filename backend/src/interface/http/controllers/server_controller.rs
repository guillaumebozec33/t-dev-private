...
mod tests {
    ...
    fn make_invitation(server_id: Uuid, user_id: Uuid) -> Invitation {
        Invitation::new(server_id, user_id, Some(10), Some(Utc::now() + chrono::Duration::days(1)))
    }
    ...
    async fn test_join_server_success() {
        ...
        mock_server_repo
            ...
            .returning(move |_| Ok(Some(make_invitation(server_id, user_id))));
